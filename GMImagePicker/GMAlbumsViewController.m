...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.navigationItem.title = NSLocalizedStringFromTableInBundle(@"albums.title", @"GMImagePicker", self.imagePickerController.assetBundle, nil);
...
{
    GMAssetsViewController *assetsViewController = segue.destinationViewController;
...
{
    GMAlbumCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AlbumCell" forIndexPath:indexPath];
